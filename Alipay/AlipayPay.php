...
include_once 'AlipayNotify.php';  //need add this line if we use notifycall
class AlipayPay {
     ...
     */
    public $partner = '2088xxxxxxxxxxxx';

    /**
     * @var String 收款支付宝账号
     */
    public $seller_email = 'yyyyyyy@xxxxxxxxxxxx.com';

    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = 'dgfdfgdfsgxxxxxxxxxxxxxxxxx';
     ...
     */
    public $notify_url = 'https://xxxxxxxxxxxxxx.com/cart/notifycall';

    /**
     * @var String 页面跳转同步通知页面路径
     * 需http://格式的完整路径，不能加?id=123这类自定义参数，不能写成http://localhost/
     */
    public $return_url = 'https://xxxxxxxxxxxxxxx.com/cart/returncall';
